...
public abstract class Memory {
   ...
   */
  public abstract int map(int addr, int len, boolean read, boolean write, boolean exec) throws MemoryMapException;
  /**
   ...
   * @param exec is the page executable
   */
  public abstract int map(RandomAccessFile file, long offset, int addr, int len, boolean read, boolean write, boolean exec) throws MemoryMapException;
  /**
   ...
   * @param addr the address of the value to load
   */
  public abstract void translateLoadSigned8(OPT_RegisterOperand addr, OPT_RegisterOperand dest);
  /**
   ...
   * @param addr the address of the value to load
   */
  public abstract void translateLoadUnsigned8(OPT_RegisterOperand addr, OPT_RegisterOperand dest);
  /**
   ...
   * @param addr the address of the value to load
   */
  public abstract void translateLoadSigned16(OPT_RegisterOperand addr, OPT_RegisterOperand dest);
  /**
   ...
   * @param addr the address of the value to load
   */
  public abstract void translateLoadUnsigned16(OPT_RegisterOperand addr, OPT_RegisterOperand dest);
  /**
   * Generate the IR code for a 32bit load
   * @param dest the register to hold the result
   * @param addr the address of the value to load
   */
  public abstract void translateLoad32(OPT_RegisterOperand addr, OPT_RegisterOperand dest);
  /**
   ...
   */
  public abstract void translateStore8(OPT_RegisterOperand addr, OPT_RegisterOperand src);
  /**
   * Generate the IR code for a 16bit store
   * @param src the register that holds the value to store
   * @param addr the address of the value to store
   */
  public abstract void translateStore16(OPT_RegisterOperand addr, OPT_RegisterOperand src);
  /**
