...
public abstract class PPC_ProcessSpace extends ProcessSpace implements
   ...
   */
  public int r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14,
   ...
   */
  public double f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13,
  ...
  /**
   * Pointer to where we are up to in the program (the PPC doesn't actually have
   * a program counter register, but we sometimes need to keep track of our
   * place in the binary).
   */
  public int pc;

  /**
   * When interpreting this holds the current instruction being interpretted
   */
  ...
  public void setCRfield_signedCompare(int field, int value1, int value2) {
    System.out.println("Signed compare: field=" + field + " val1=" + value1
        + " val2=" + value2);
  ...
  public void setCRfield_unsignedCompare(int field, int val1, int val2) {
    ...
    System.out.println("Unsigned compare: field=" + field + " val1=" + value1
        + " val2=" + value2);
    crf_lt[field] = value1 < value2;
    crf_gt[field] = value1 > value2;
   ...
   * @param crb
   *          condition register bit within field
   */
  ...
  public String toString() {
    return "r0=0x" + Integer.toHexString(r0) + " r1=0x"
        + Integer.toHexString(r1) + " r2=0x" + Integer.toHexString(r2)
        + " r3=0x" + Integer.toHexString(r3) + "\nr4=0x"
        + Integer.toHexString(r4) + " r5=0x" + Integer.toHexString(r5)
        + " r6=0x" + Integer.toHexString(r6) + " r7=0x"
        + Integer.toHexString(r7) + "\nr8=0x" + Integer.toHexString(r8)
        + " r9=0x" + Integer.toHexString(r9) + " r10=0x"
        + Integer.toHexString(r10) + " r11=0x" + Integer.toHexString(r11)
        + "\nr12=0x" + Integer.toHexString(r12) + " r13=0x"
        + Integer.toHexString(r13) + " r14=0x" + Integer.toHexString(r14)
        + " r15=0x" + Integer.toHexString(r15) + "\nr16=0x"
        + Integer.toHexString(r16) + " r17=0x" + Integer.toHexString(r17)
        + " r18=0x" + Integer.toHexString(r18) + " r19=0x"
        + Integer.toHexString(r19) + "\nr20=0x" + Integer.toHexString(r20)
        + " r21=0x" + Integer.toHexString(r21) + " r22=0x"
        + Integer.toHexString(r22) + " r23=0x" + Integer.toHexString(r23)
        + "\nr24=0x" + Integer.toHexString(r24) + " r25=0x"
        + Integer.toHexString(r25) + " r26=0x" + Integer.toHexString(r26)
        + " r27=0x" + Integer.toHexString(r27) + "\nr28=0x"
        + Integer.toHexString(r28) + " r29=0x" + Integer.toHexString(r29)
        + " r30=0x" + Integer.toHexString(r30) + " r31=0x"
        + Integer.toHexString(r31);
  }
  ...
  public byte[] readRegisterGDB(int regNum) {
    ...
    case 104:
      ...
      break; // vrsave
    default:
      System.err.println("Unknown GDB register " + regNum);
      value = 0;
      break;
    }
    byte[] result;
