...
/**
 * The decoder for the SIB byte of the instruction. The SIB byte
 * generally encodes an address of (index * power(2, ss) + base)
 */
class X86_SIB_Decoder {
  ...
  /**
	...
	* @param mod the modifier from the ModRM byte
	*/
  int getBase(int mod) {
	 switch (base) {
	 case 0:  return X86_Registers.EAX;
	 case 1:  return X86_Registers.ECX;
	 case 2:  return X86_Registers.EDX;
	 case 3:  return X86_Registers.EBX;
	 case 4:  return X86_Registers.ESP;
	 case 5:  return (mod == 0) ? -1 : X86_Registers.EBP;
	 case 6:  return X86_Registers.ESI;
	 default: return X86_Registers.EDI;
	 }
  }
  /**
  ...
  int getIndex() {
	 ...
	 case 3:  return X86_Registers.EBX;
	 case 4:  return -1;
	 case 5:  return X86_Registers.EBP;
	 case 6:  return X86_Registers.ESI;
	 default: return X86_Registers.EDI;
	 }
  }
  ...
  String disassemble(int mod) {
	 ...
	 String baseString;
	 switch (base) {
	 case 0:   baseString = "EAX"; break;
	 case 1:   baseString = "ECX"; break;
	 case 2:   baseString = "EDX"; break;
	 case 3:   baseString = "EBX"; break;
	 case 4:   baseString = "ESP"; break;
	 case 5:   baseString = (mod == 0) ? "" : "EBP";    break;
	 case 6:   baseString = "ESI"; break;
	 default:  baseString = "EDI"; break;
	 }
	 switch (index) {
	 case 0:  return baseString + "+EAX" + scale;
	 case 1:  return baseString + "+ECX" + scale;
	 case 2:  return baseString + "+EDX" + scale;
	 case 3:  return baseString + "+EBX" + scale;
	 case 4:  return baseString;
	 case 5:  return baseString + "+EBP" + scale;
	 case 6:  return baseString + "+ESI" + scale;
	 default: return baseString + "+EDI" + scale;
	 }
  }
}
