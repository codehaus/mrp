...
public final class StackManager extends GenericStackManager {
  ...
  */
  ...
  public final void insertNormalPrologue() {
    ...
    ptr.insertBefore(MIR_Store.create(PPC_STW, I(S1), A(FP), AC(STACKFRAME_METHOD_ID_OFFSET))); // 9
  ...
  final void insertExceptionalPrologue() {
    ...
    ptr.insertBefore(MIR_Store.create(PPC_STW, I(R0), A(FP), AC(STACKFRAME_METHOD_ID_OFFSET)));
