...
public final class OPT_ConditionOperand extends OPT_Operand {
   ...
   * @return a newly created condition code operand
   */
  public static OPT_ConditionOperand CARRY_FROM_ADD() {
    return new OPT_ConditionOperand(CARRY_FROM_ADD);
  }
   ...
   * @return a newly created condition code operand
   */
  public static OPT_ConditionOperand OVERFLOW_FROM_ADD() {
    return new OPT_ConditionOperand(OVERFLOW_FROM_ADD);
  }
   ...
   * @return a newly created condition code operand
   */
  public static OPT_ConditionOperand BORROW_FROM_SUB() {
    return new OPT_ConditionOperand(BORROW_FROM_SUB);
  }
   ...
   * @return a newly created condition code operand
   */
  public static OPT_ConditionOperand OVERFLOW_FROM_SUB() {
    return new OPT_ConditionOperand(OVERFLOW_FROM_SUB);
  }
   ...
   * @return a newly created condition code operand
   */
  public static OPT_ConditionOperand BIT_TEST() {
    return new OPT_ConditionOperand(BIT_TEST);
  }
  ...
  private static boolean higher(int x, int y) {
    return ((long)x & 0xFFFFFFFFL) > ((long)y & 0xFFFFFFFF);
  }
